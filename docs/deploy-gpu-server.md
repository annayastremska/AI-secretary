...
`demos/upload_app/config-server.yaml` — **УТРАЧЕНИЙ 01.09**: він жив лише на сервері й у git не поїхав (перелік утраченого — `docs/tasks/2026-09-01_server-shutdown-what-was-lost.md`). Секретів у ньому не було. Був зроблений із `config-gpu.yaml`,
