...
def build_checks(ctx):
    ...
    return {
        ...
        # Доповнення (скільком НЕ у стані) -- перевіряється виконанням: воно
        # рахується від штатки, а .md-файли пайплайна штатки не містять.
        "count_not_in_state": dict(
            kind="execute",
            params={"dims": ["leave"], "on_date": "2026-08-30"}),
