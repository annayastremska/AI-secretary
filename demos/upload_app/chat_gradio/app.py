...
def answer_reference(question):
    ...
    if not hits:
        ...
        #
        # Замість неправди -- правда про корпус, тим самим запитом, яким її
        # рахує сторінка статистики. Це «окрема гілка» в термінах відповіді
        # Андрія 28.08: питання ПРО КОРПУС -- не питання про норму, і відповідь
        # на нього -- лічильник, а не цитата.
