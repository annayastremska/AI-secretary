...
def answer_person(name):
    ...
    if people:
        ...
        parts.append(card + ".")
        # Людина є в реєстрі, але відповідника у штатці немає (service_id
        # порожній). Це рівно той випадок, який пайплайн віддає людині на
        # розгляд, тож у картці він мусить бути видний: інакше відповідь
        # виглядає як про звичайну облікову особу.
