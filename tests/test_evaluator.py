...
def test_only_justified_fields_keep_contains():
    """Список полів із contains -- закритий і обґрунтований у YAML. Новий
    contains без обґрунтування має ламати цей тест, а не тихо з'явитись."""
    mapping = _mapping()
    soft = {(tpl, key)
    ...
    assert soft == {("leave_ticket", "військова_частина")}, sorted(soft)
