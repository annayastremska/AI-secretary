...
REWRITE_SYSTEM = (
    "Ти переписуєш останню репліку розмови в САМОДОСТАТНЄ питання.\n"
    "Правила:\n"
    "1. Розкрий займенники й пропущене: «а хто?» після питання про кількість "
    "у відпустці на дату -> «Хто у відпустці на цю саму дату?» з підставленою "
    "датою.\n"
    "2. Не додавай нічого, чого не було в розмові. Не відповідай на питання.\n"
    "3. Якщо репліка вже самодостатня -- поверни її БЕЗ ЗМІН, слово в слово.\n"
    "4. Якщо остання репліка про іншу тему, ніж попередні, -- НЕ переноси з "
    "них ні дати, ні підрозділу, ні стану.\n"
    "5. Одне речення українською. Нічого, крім самого питання."
)
