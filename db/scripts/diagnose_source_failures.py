...
def main():
    ...
    # ДОСЛІВНІ ЦИТАТИ = цитата є підрядком (OK + інша_одиниця): в обох цитата
    # дослівна, різниця лише в тому, ЧИ та адреса, що в істині. Це і є метрика
    # «дослівні цитати з документів»: чи показане джерело справжнє, а не про
    # влучність у призначену одиницю.
    verbatim = counts["OK"] + counts["інша_одиниця"]
    print(f"ДОСЛІВНИХ ЦИТАТ: {verbatim} із {tot} "
          f"(не дослівних {counts['не_дослівно']} -- продукт їх відкидає й "
          f"відмовляє)")
    print(f"  розклад: влучив у ту саму одиницю {counts['OK']}, "
          f"дослівно але інша адреса {counts['інша_одиниця']}, "
