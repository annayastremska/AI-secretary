...
# Формулювання пункту про відмову -- продове, як у `prompts/route.md`.
# Підміняється змінною середовища REFUSAL_RULE лише для A/B: типове значення
# мусить лишатись тим, що справді працює в застосунку, інакше замір описує
# не апку.
REFUSAL_RULE = os.environ.get(
    "REFUSAL_RULE",
