...
**У `pipeline/` немає коду підключення до бази даних**, і це навмисно:
"Зовнішнє сховище (MinIO) і база даних — поза її межами" (вище в цьому файлі).
Завантажувач у БД (`ai_secretary_loader.py`, `schema_dump.sql`, згадані в
`docs/contracts/2026-08-11_database-handoff.md`) — код команди БД, не цієї
частини роботи.
